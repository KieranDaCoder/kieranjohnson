  ...
  return (
    <footer className="border-t border-charcoal/10 px-6 py-12 md:px-12">
      <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="display text-3xl text-navy">Kieran Johnson</p>
          <p className="mt-2 text-sm text-charcoal/60">
            Communications · PR &amp; Advertising · Melbourne
          </p>
        </div>
        <div className="flex gap-8 text-sm uppercase tracking-wide">
          <a href="mailto:hello@example.com" className="link-sweep text-charcoal/70 hover:text-sky">
            Email
          </a>
          <a
            ...
            className="link-sweep text-charcoal/70 hover:text-sky"
          >
            LinkedIn
          </a>
          <Link href="/contact" className="link-sweep text-charcoal/70 hover:text-sky">
            Contact
          </Link>
        </div>
      </div>
